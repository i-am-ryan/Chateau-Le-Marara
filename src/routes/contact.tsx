...
import { MapPin, Mail, Phone, ArrowRight, ArrowLeft, Check, Users, Baby, Minus, Plus } from "lucide-react";
...
// ── All 20 rooms with fresh, non-repeated Unsplash images ──
const ROOMS_LIST = [
  { id: "comtesse",    nameEn: "Comtesse De Bwishaza",         adults: 2, children: 1, price: 350, img: "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=600&q=85" },
  { id: "delicatessen",nameEn: "Delicatessen",                 adults: 2, children: 0, price: 350, img: "https://images.unsplash.com/photo-1596394516093-501ba68a0ba6?w=600&q=85" },
  { id: "dreamoflove", nameEn: "Dream Of Love",                adults: 2, children: 0, price: 350, img: "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=600&q=85" },
  { id: "foudtoi",     nameEn: "Fou De Toi",                   adults: 2, children: 1, price: 350, img: "https://images.unsplash.com/photo-1590490360182-c33d57733427?w=600&q=85" },
  { id: "kingkigeli",  nameEn: "King Kigeli",                  adults: 2, children: 0, price: 350, img: "https://images.unsplash.com/photo-1578683010236-d716f9a3f461?w=600&q=85" },
  { id: "kingmutara",  nameEn: "King Mutara",                  adults: 2, children: 0, price: 350, img: "https://images.unsplash.com/photo-1600210492493-0946911123ea?w=600&q=85" },
  { id: "kingyuhi",    nameEn: "King Yuhi",                    adults: 1, children: 0, price: 350, img: "https://images.unsplash.com/photo-1571003123894-1f0594d2b5d9?w=600&q=85" },
  { id: "labelldemai", nameEn: "La Belle De Mai",              adults: 2, children: 0, price: 350, img: "https://images.unsplash.com/photo-1602002418082-a4443e081dd1?w=600&q=85" },
  { id: "lanuit",      nameEn: "La Nuit De Madame",            adults: 2, children: 0, price: 350, img: "https://images.unsplash.com/photo-1595576508898-0ad5c879a061?w=600&q=85" },
  { id: "lapromesse",  nameEn: "La Promesse De L'Horizon",     adults: 2, children: 0, price: 350, img: "https://images.unsplash.com/photo-1560185007-cde436f6a4d0?w=600&q=85" },
  { id: "lareve",      nameEn: "La Rêve De Mademoiselle",      adults: 2, children: 0, price: 350, img: "https://images.unsplash.com/photo-1564078516393-cf04bd966897?w=600&q=85" },
  { id: "lepresident", nameEn: "Le Président",                 adults: 2, children: 0, price: 250, img: "https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd?w=600&q=85" },
  { id: "lightofheart",nameEn: "Light Of My Heart",           adults: 2, children: 0, price: 350, img: "https://images.unsplash.com/photo-1616594039964-ae9021a400a0?w=600&q=85" },
  { id: "princesse",   nameEn: "Princesse De Ishangi",         adults: 2, children: 0, price: 350, img: "https://images.unsplash.com/photo-1631049552057-403cdb8f0658?w=600&q=85" },
  { id: "queennyira",  nameEn: "Queen Nyiratunga",             adults: 2, children: 0, price: 350, img: "https://images.unsplash.com/photo-1549294413-26f195200c16?w=600&q=85" },
  { id: "queenofheart",nameEn: "Queen Of My Heart",           adults: 2, children: 0, price: 350, img: "https://images.unsplash.com/photo-1540518614846-7eded433c457?w=600&q=85" },
  { id: "queenofrom",  nameEn: "Queen Of Romance",             adults: 2, children: 0, price: 350, img: "https://images.unsplash.com/photo-1584132967334-10e028bd69f7?w=600&q=85" },
  { id: "promissoflove",nameEn: "The Promise Of Love",        adults: 2, children: 0, price: 350, img: "https://images.unsplash.com/photo-1507652313519-d4e9174996dd?w=600&q=85" },
  { id: "vow",         nameEn: "The Vow Of Love",              adults: 2, children: 0, price: 350, img: "https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?w=600&q=85" },
  { id: "youname",     nameEn: "Your Name Among The Stars",   adults: 2, children: 0, price: 350, img: "https://images.unsplash.com/photo-1555854877-bab0e564b8d5?w=600&q=85" },
];
...
const CONTACT_CSS = `
  ...
  @media (max-width: 640px) {
    [data-step1-dates] { grid-template-columns: 1fr !important; }
    [data-room-card] { grid-template-columns: 80px 1fr !important; }
  }
`;
...
function Stepper({ value, min = 0, max = 10, onChange }: { value: number; min?: number; max?: number; onChange: (v: number) => void }) {
  return (
    <div style={{ display: "flex", alignItems: "center", border: "1px solid rgba(44,44,44,0.12)", background: "white" }}>
      <button onClick={() => onChange(Math.max(min, value - 1))} style={{ width: "36px", height: "36px", border: "none", background: "transparent", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--ink)" }}>
        <Minus size={13} />
      </button>
      ...
      <button onClick={() => onChange(Math.min(max, value + 1))} style={{ width: "36px", height: "36px", border: "none", background: "transparent", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--ink)" }}>
        <Plus size={13} />
      </button>
    </div>
  );
...
function Contact() {
  ...
  // Per-room subtotal: multiply by nights when dates are set, otherwise show per-night rate
  const roomLineTotal = (room: typeof ROOMS_LIST[0]) =>
    nights > 0
      ? room.price * (quantities[room.id] ?? 0) * nights
      : room.price * (quantities[room.id] ?? 0);
  ...
  return (
    <main style={{ background: "var(--cream)", minHeight: "100vh" }}>
      ...
      <section style={{ position: "relative", height: "100dvh", overflow: "hidden", display: "flex", alignItems: "flex-end" }}>
        <img
          src="https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=2400&q=90"
          ...
          <div style={{ maxWidth: "1300px", margin: "0 auto", display: "flex", alignItems: "stretch" }}>
            {[
              ...
              <div key={n} style={{
                ...
                marginRight: "8px", cursor: n < step ? "pointer" : "default",
              ...
              <div data-booking-layout style={{ display: "grid", gridTemplateColumns: "1fr 320px", gap: "clamp(24px,4vw,56px)", alignItems: "start" }}>
                ...
                <div>
                  ...
                  <div style={{ marginBottom: "clamp(32px,4vw,48px)" }}>
                    ...
                    <h2 style={{ fontFamily: "var(--font-display)", fontWeight: 300, fontSize: "clamp(26px,3vw,42px)", color: "var(--navy)", margin: "0 0 8px 0", lineHeight: 1.1 }}>
                    ...
                    <p style={{ fontFamily: "var(--font-sans)", fontSize: "13px", fontWeight: 300, color: "rgba(44,44,44,0.5)", margin: 0 }}>
                      {lang === "en" ? "Select your dates, number of guests, then choose your rooms below." : "Sélectionnez vos dates, le nombre d'invités, puis choisissez vos chambres."}
                    </p>
                  </div>

                  {/* Date + guest grid */}
                  <div data-step1-dates style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: "clamp(10px,1.5vw,18px)", marginBottom: "clamp(32px,4vw,48px)" }}>
                    <Field label={lang === "en" ? "Check-in Date" : "Arrivée"} type="date">
                    ...
                    <Field label={lang === "en" ? "Check-out Date" : "Départ"} type="date">
                  ...
                  {/* Gold divider */}
                  <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "clamp(24px,3vw,36px)" }}>
                    ...
                    <p style={{ fontFamily: "var(--font-label)", fontSize: "9px", letterSpacing: "0.35em", textTransform: "uppercase", color: "var(--gold)", margin: 0, whiteSpace: "nowrap" }}>
                      {lang === "en" ? "Select Rooms" : "Choisir les Chambres"}
                    </p>
                    <div style={{ flex: 1, height: "1px", background: "rgba(44,44,44,0.1)" }} />
                  </div>
                      ...
                      return (
                        <div key={room.id} data-room-card style={{
                          ...
                          <div style={{ position: "relative", overflow: "hidden" }}>
                            ...
                            {selected && (
                              <div style={{ position: "absolute", inset: 0, background: "rgba(209,178,116,0.25)" }} />
                            )}
                          </div>

                          {/* Info */}
                          <div style={{ padding: "14px 16px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
                            <p style={{ fontFamily: "var(--font-display)", fontStyle: "italic", fontWeight: 300, fontSize: "clamp(14px,1.2vw,18px)", color: "var(--navy)", margin: "0 0 4px 0", lineHeight: 1.2 }}>
                              {room.nameEn}
                            </p>
                            <div style={{ display: "flex", gap: "14px", alignItems: "center", flexWrap: "wrap" }}>
                              <span style={{ display: "flex", alignItems: "center", gap: "4px", fontFamily: "var(--font-label)", fontSize: "9px", letterSpacing: "0.2em", textTransform: "uppercase", color: "rgba(44,44,44,0.45)" }}>
                                <Users size={10} /> {room.adults} {lang === "en" ? "adults" : "adultes"}{room.children > 0 && `, ${room.children} ${lang === "en" ? "child" : "enfant"}`}
                              </span>
                              <span style={{ fontFamily: "var(--font-label)", fontSize: "9px", letterSpacing: "0.18em", color: "rgba(44,44,44,0.35)", textTransform: "uppercase" }}>
                                1 {lang === "en" ? "room available" : "chambre disponible"}
                              </span>
                            </div>
                          </div>

                          {/* Price + qty */}
                          <div style={{ padding: "14px 16px", display: "flex", flexDirection: "column", alignItems: "flex-end", justifyContent: "center", gap: "8px", minWidth: "120px" }}>
                            <div style={{ textAlign: "right" }}>
                              <p style={{ fontFamily: "var(--font-display)", fontWeight: 200, fontSize: "clamp(18px,1.8vw,24px)", color: "var(--navy)", margin: 0, lineHeight: 1 }}>
                                ${room.price}
                              </p>
                              <p style={{ fontFamily: "var(--font-label)", fontSize: "8px", letterSpacing: "0.18em", color: "rgba(44,44,44,0.4)", margin: "2px 0 0 0" }}>
                                / {lang === "en" ? "night" : "nuit"}
                              </p>
                            </div>
                ...
                <div data-summary-panel style={{ position: "sticky", top: "88px" }}>
                  <div style={{ background: "var(--navy)", color: "white", padding: "clamp(24px,3vw,32px)" }}>
                    ...
                    {[
                      ...
                      <div key={label} style={{ borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: "12px", marginBottom: "12px" }}>
                        <p style={{ fontFamily: "var(--font-label)", fontSize: "8px", letterSpacing: "0.28em", textTransform: "uppercase", color: "rgba(255,255,255,0.4)", margin: "0 0 4px 0" }}>{label}</p>
                    ...
                    {selectedRooms.length > 0 && (
                      <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: "10px", marginBottom: "0" }}>
                        {selectedRooms.map(r => (
                          <div key={r.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: "8px" }}>
                            <p style={{ fontFamily: "var(--font-display)", fontStyle: "italic", fontSize: "12px", fontWeight: 300, color: "rgba(255,255,255,0.6)", margin: 0, maxWidth: "140px", lineHeight: 1.3 }}>{r.nameEn}</p>
                            <p style={{ fontFamily: "var(--font-display)", fontSize: "14px", fontWeight: 300, color: "rgba(255,255,255,0.85)", margin: 0, whiteSpace: "nowrap" }}>
                              ${roomLineTotal(r).toLocaleString()}
                              {nights === 0 && <span style={{ fontFamily: "var(--font-label)", fontSize: "8px", letterSpacing: "0.12em", color: "rgba(255,255,255,0.35)", marginLeft: "3px" }}>/nt</span>}
                            </p>
                          </div>
                        ))}
                      </div>
                    ...
                    <div style={{ borderTop: "1px solid rgba(255,255,255,0.15)", paddingTop: "16px", marginTop: "4px" }}>
                      ...
                      {nights > 0 && selectedRooms.length > 0 && (
                        <p style={{ fontFamily: "var(--font-label)", fontSize: "8px", letterSpacing: "0.18em", color: "rgba(255,255,255,0.3)", margin: 0, textAlign: "right" }}>
                          {nights} {lang === "en" ? `night${nights !== 1 ? "s" : ""}` : `nuit${nights !== 1 ? "s" : ""}`}
                        </p>
                      )}
                      {nights === 0 && selectedRooms.length > 0 && (
                  ...
                  {/* Contact details below summary */}
                  <div style={{ background: "white", padding: "clamp(18px,2vw,24px)", marginTop: "2px", display: "flex", flexDirection: "column", gap: "12px" }}>
                    {[
                      ...
                      <div key={i} style={{ display: "flex", gap: "10px", alignItems: "center" }}>
                        ...
                        <p style={{ fontFamily: "var(--font-sans)", fontSize: "12px", fontWeight: 300, color: "rgba(44,44,44,0.65)", margin: 0, lineHeight: 1.4 }}>{text}</p>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            <motion.div key="step2" initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -16 }} transition={{ duration: 0.45 }}>
              <div data-booking-layout style={{ display: "grid", gridTemplateColumns: "1fr 320px", gap: "clamp(24px,4vw,56px)", alignItems: "start" }}>
                <div>
                  ...
                  {/* Security badges */}
                  <div style={{ display: "flex", gap: "20px", alignItems: "center", background: "rgba(44,44,44,0.04)", padding: "14px 18px", marginBottom: "clamp(24px,3vw,36px)" }}>
                  ...
                  <div style={{ display: "flex", gap: "12px" }}>
                    <button onClick={() => setStep(1)} style={{
                      ...
                      border: "1px solid rgba(44,44,44,0.2)", cursor: "pointer",
                ...
                <div data-summary-panel style={{ position: "sticky", top: "88px" }}>
                  <div style={{ background: "var(--navy)", color: "white", padding: "clamp(24px,3vw,32px)" }}>
                    ...
                    <div style={{ borderTop: "1px solid rgba(255,255,255,0.15)", paddingTop: "12px", marginTop: "4px", display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                      <p style={{ fontFamily: "var(--font-label)", fontSize: "9px", letterSpacing: "0.22em", textTransform: "uppercase", color: "rgba(255,255,255,0.5)", margin: 0 }}>
                        {nights > 0 ? (lang === "en" ? "Total" : "Total") : (lang === "en" ? "From" : "À partir de")}
                      </p>
                    ...
                    <p style={{ fontFamily: "var(--font-label)", fontSize: "8px", letterSpacing: "0.15em", color: "rgba(255,255,255,0.3)", margin: "4px 0 0 0", textAlign: "right" }}>
                      {nights > 0
                        ? `${fmtDate(checkIn)} → ${fmtDate(checkOut)} · ${nights} ${lang === "en" ? `night${nights !== 1 ? "s" : ""}` : `nuit${nights !== 1 ? "s" : ""}`}`
            ...
            <motion.div key="step3" initial={{ opacity: 0, scale: 0.97 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.55 }}>
              <div style={{ maxWidth: "640px", margin: "0 auto", textAlign: "center", padding: "clamp(48px,8vw,80px) 0" }}>
                ...
                <p style={{ fontFamily: "var(--font-display)", fontStyle: "italic", fontSize: "clamp(16px,1.5vw,22px)", fontWeight: 300, color: "var(--ocean)", margin: "0 0 36px 0", lineHeight: 1.6 }}>
                  {lang === "en" ? "Your reservation at Château le Marara is being prepared. Our concierge will be in touch within 24 hours." : "Votre réservation au Château le Marara est en cours de préparation. Notre concierge vous contactera dans les 24 heures."}
                </p>
                <Link to="/" style={{
